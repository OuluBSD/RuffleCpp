// C++ translation of core/src/avm2/globals/vector_uint.rs
// Vector.<uint> implementation

#ifndef RUFFLE_CORE_AVM2_GLOBALS_VECTOR_UINT_H
#define RUFFLE_CORE_AVM2_GLOBALS_VECTOR_UINT_H
...
// Re-export vector_uint_initializer from vector module
using vector_uint_initializer = vector::instance_init;
...
// Re-export vector_uint_allocator from object module
template<typename GC>
using vector_uint_allocator = ruffle::core::avm2::object::vector_allocator<GC>;

/// Vector.<uint>.concat implementation
template<typename GC>
Value<GC> concat(
...
#endif // RUFFLE_CORE_AVM2_GLOBALS_VECTOR_UINT_H
