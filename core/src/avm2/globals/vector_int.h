// C++ translation of core/src/avm2/globals/vector_int.rs
// Vector.<int> implementation

#ifndef RUFFLE_CORE_AVM2_GLOBALS_VECTOR_INT_H
#define RUFFLE_CORE_AVM2_GLOBALS_VECTOR_INT_H
...
// Re-export vector_int_initializer from vector module
using vector_int_initializer = vector::instance_init;
...
// Re-export vector_int_allocator from object module
template<typename GC>
using vector_int_allocator = ruffle::core::avm2::object::vector_allocator<GC>;

/// Vector.<int>.concat implementation
template<typename GC>
Value<GC> concat(
...
#endif // RUFFLE_CORE_AVM2_GLOBALS_VECTOR_INT_H
