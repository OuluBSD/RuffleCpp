// C++ translation of core/src/avm2/globals/vector_object.rs
// Vector.<Object> implementation

#ifndef RUFFLE_CORE_AVM2_GLOBALS_VECTOR_OBJECT_H
#define RUFFLE_CORE_AVM2_GLOBALS_VECTOR_OBJECT_H
...
// Re-export vector_object_initializer from vector module
using vector_object_initializer = vector::instance_init;
...
// Re-export vector_object_allocator from object module
template<typename GC>
using vector_object_allocator = ruffle::core::avm2::object::vector_allocator<GC>;

/// Vector.<Object>.concat implementation
template<typename GC>
Value<GC> concat(
...
#endif // RUFFLE_CORE_AVM2_GLOBALS_VECTOR_OBJECT_H
