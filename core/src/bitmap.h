// C++ translation of core/src/bitmap.rs
// Bitmap handling and size validation

#ifndef RUFFLE_CORE_BITMAP_H
#define RUFFLE_CORE_BITMAP_H
...
// Submodules - forward declarations
...
///
/// \param swf_version The SWF version to check limits for
/// \param width The width of the bitmap
/// \param height The height of the bitmap
/// \return true if the size is valid for the given SWF version
